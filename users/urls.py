...
from .views import UserRegisterForm, UserLoginView,UserProfileView, UserPasswordChangeView, UserPasswordResetDoneView,UpdateUserProfileView #user_profile_view
